...
var jsonlint = (function () {
    var parser = {
        ...
        table: [{
            ...
            17: [1, 14],
            23: [1, 15]
        }, {18: [2, 17], 22: [2, 17]}, {18: [2, 15], 22: [2, 15]}, {
            22: [2, 21],
            24: [2, 21]
        }],
            ...
            while (true) {
                ...
                _handle_error:
                    if (typeof action === 'undefined' || !action.length || !action[0]) {
                        ...
                        symbol = TERROR;         // insert generic error symbol
                                                 // as new lookahead
                        state = stack[stack.length - 1];
                        action = table[state] && table[state][TERROR];
                        recovering = 3; // allow 3 real symbols to be shifted
                                        // before reporting a new error
                    }
                ...
                switch (action[0]) {
                    ...
                    case 2: // reduce
                        ...
                        yyval.$ = vstack[vstack.length - len]; // default to $$
                                                               // = $1
