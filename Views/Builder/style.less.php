...
echo $view->render(
    'MauticContactClientBundle:Builder\Bar:style.less.php',
    [
        'preview' => $preview,
    ]
);
...
echo $view->render(
    'MauticContactClientBundle:Builder\Modal:style.less.php',
    [
        'preview' => $preview,
    ]
);
...
echo $view->render(
    'MauticContactClientBundle:Builder\Notification:style.less.php',
    [
        'preview' => $preview,
    ]
);
...
echo $view->render(
    'MauticContactClientBundle:Builder\Page:style.less.php',
    [
        'preview' => $preview,
    ]
);
