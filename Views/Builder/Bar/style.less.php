...
<?php echo $view->render('MauticContactClientBundle:Builder\Bar:collapser.less.php'); ?>
...
<?php echo $view->render('MauticContactClientBundle:Builder\Bar:animations.less.php'); ?>
<?php echo $view->render('MauticContactClientBundle:Builder\Bar:shared.less.php'); ?>
.mf-bar {
    &.mf-animate {
        .barAnimate();
    }
