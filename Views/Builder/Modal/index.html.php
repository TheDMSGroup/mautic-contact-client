...
?>
    ...
    <div class="mautic-contactclient mf-<?php echo $style; ?><?php if ($placement) {
    echo " mf-$style-$placement";
} ?><?php echo $animate; ?>">
        <div class="mf-<?php echo $style; ?>-container">
            <div class="mf-<?php echo $style; ?>-close">
                <a href="javascript:void(0)"<?php if (!empty($preview)): echo ' onclick="Mautic.closeContactClientModal(\''.$style.'\')"'; endif; ?>>x</a>
            </div>
...
<?php if ($style == 'modal'): ?>
    <div class="mf-move-to-parent mf-<?php echo $style; ?>-overlay mf-<?php echo $style; ?>-overlay-<?php echo $contactclient['id']; ?>"></div>
<?php endif; ?>