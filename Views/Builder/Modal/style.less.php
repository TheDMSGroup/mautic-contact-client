...
<?php echo $view->render('MauticContactClientBundle:Builder\Modal:animations.less.php'); ?>
<?php echo $view->render('MauticContactClientBundle:Builder\Modal:overlay.less.php'); ?>
