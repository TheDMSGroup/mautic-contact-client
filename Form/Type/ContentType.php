...
class ContentType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add(
            ...
            'text',
            [
                'label'      => 'mautic.contactclient.form.headline',
        ...
        $builder->add(
            ...
            'text',
            [
                'label'      => 'mautic.contactclient.form.tagline',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
        ...
        $builder->add(
            ...
            'text',
            [
                'label'      => 'mautic.contactclient.form.link_text',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
                    'onblur'       => 'Mautic.contactclientUpdatePreview()',
        ...
        $builder->add(
            ...
            'text',
            [
                'label'      => 'mautic.contactclient.form.link_url',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
                    'onblur'       => 'Mautic.contactclientUpdatePreview()',
        ...
        $builder->add(
            ...
            'yesno_button_group',
            [
                'label' => 'mautic.contactclient.form.link_new_window',
        ...
        $builder->add(
            ...
            [
                ...
                'label'      => 'mautic.contactclient.form.font',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
                    'onchange'     => 'Mautic.contactclientUpdatePreview()',
